...
CREATE TABLE `categories` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_par_id_idx` (`parentId`),
  CONSTRAINT `fk_par_id` FOREIGN KEY (`parentId`) REFERENCES `categories` (`id`) ON DELETE RESTRICT
...
-- Dump completed on 2020-02-10 10:01:15
